...
### Frontend (scaffold — UI in progress)
- **Leaflet map** with location pin for precise coordinate selection
- **Onboarding flow** — collects tree age, tapping system, number of trees, preferred start time
